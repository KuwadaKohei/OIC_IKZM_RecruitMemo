...
<nav class="d-flex flex-column h-100 bg-dark text-white p-3 gap-2">
	...
	<div class="list-group list-group-flush">
		<a
			...
			href="${contextPath}/ReportList"> <i
			class="bi bi-house-door-fill"></i> <span>トップ</span>
		</a> <a
			class="list-group-item list-group-item-action d-flex align-items-center gap-2 bg-transparent text-white border-0"
			href="${contextPath}/ReportNew"> <i
			class="bi bi-plus-circle-fill"></i> <span>新規投稿</span>
		</a> <a
			class="list-group-item list-group-item-action d-flex align-items-center gap-2 bg-transparent text-white border-0"
	...
	<c:if test="${loginUser ne null and loginUser.admin}">
		<div class="mt-3 pt-3 border-top border-secondary">
			<span class="text-uppercase text-secondary small">Admin</span> <a
				class="list-group-item list-group-item-action d-flex align-items-center gap-2 bg-transparent text-white border-0 px-0"
